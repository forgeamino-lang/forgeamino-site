...
export async function createInvoice(accessToken, realmId, { customer, order }) {
      ...
      // Manual override: GlobalTaxCalculation='TaxExcluded' + TxnTaxDetail.TotalTax tells QBO
      // not to recompute tax and to post the pre-calculated amount to the sales tax payable account.
